        ...
        <div>
            ...
            <div className={styles.policyContainer}>
                ...
                <ul>
                    ...
                    <li>to protect against imminent harm to the rights, property or safety of the Application/Website/ Think and Learn Private Limited or its users or the public as required or permitted by law;</li>
                ...
                <h4>Alerts</h4>
                <p>We may alert you by email or phone (through sms/call) to inform you about new service offerings of the Company and its subsidiaries/affiliatesor other information which we feel might be useful for you, through theCompany or its subsidiaries/affiliates.</p>
                <h4>Public Forums</h4>
                ...
                <h4>How Long Do We Retain User Data?</h4>
                ...
                <p>Our Grievance Officer shall undertake all reasonable efforts to address your grievances at the earliest possible opportunity. You may contact us at: Grievance Officer: Mr. Kaushlendra Kumar Address: B-311, Second Floor, Savitry Apartment, VIP Road, Zirakpur, Punjab -140603, India. Reach out to us on support@mymegaminds.com, in case of any queries.</p>
                <h3 className={styles.terms}> Terms & Conditions</h3>
                <p>These Terms & Conditions (“<b>Terms</b>”) of (a) use of our website www.mymegaminds.com (“<b>Website</b>”), our applications (“<b>Application</b>”) or any products or services in connection with the Application/Website/products (“<b>Services</b>”)  or (b) any modes of registrations or usage of products, including through SD cards, tablets or other storage/transmitting device  are between Megamind Education & Welfare Pvt Ltd (“<b>Company/We/Us/Our</b>”) and its users (“<b>User/You/Your</b>”).</p>
                ...
                <ol type='A'>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                Notice: All notices served by the Company shall be provided via email to Your account or as a general notification on the Application. Any notice to be provided to the Company should be sent to support@mymegaminds.com.
                            </li>
                            <li>
                    ...
                    <li>
                        <b>Customer Care:</b>
                        <p>We make all best endeavors to provide You with a pleasant experience. In the unlikely event that You face any issues, please contact us at support@mymegaminds.com.</p>
                    </li>
                </ol>
            </div>
            <Footer />
