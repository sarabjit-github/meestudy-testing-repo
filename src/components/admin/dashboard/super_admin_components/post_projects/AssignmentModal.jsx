...
export const AssignmentModal = ({ setIsModalOpen, projectDetails }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      assignedCoAdmin: Yup.object().required("Assign Co-Admin is required"),
              ...
              <div className={glassStyles.inputWrapper}>
                ...
                <select
                  ...
                  onChange={(e)=>{
                    ...
                    const filterCoAdmin = coAdminsArr.filter(({_id})=>_id===selectedCoAdminId);
                    let { name, email, phoneNumber, _id} = filterCoAdmin[0];
                    formik.setFieldValue("assignedCoAdmin", {name, email, phoneNumber, _id});
                  }}
                  onBlur={formik.handleBlur}
                  className={
                  ...
                  {coAdminsArr?.map(({ name, _id }) => {
                    return (
                      <option
                        key={_id}
                        value={_id}
                        //    selected={formik.values.assignedCoAdmin === value}
                      >
                        {name}
                      </option>
                    );
            ...
            <div className={glassStyles.bigInputWrapper}>
              ...
              <div className={glassStyles.inputWrapper}>
                ...
                <input
                  ...
                  id="assignmentPrice"
                  defaultValue={formik.values.assignmentPrice}
                  // value={formik.values.rejectionReason}
                  onChange={formik.handleChange}
                  onBlur={formik.handleBlur}
                  placeholder="Enter assingment price"
                  className={
                    formik.errors.assignmentPrice &&
                    formik.touched.assignmentPrice &&
                    glassStyles.errorBorder
                  }
                />
                {formik.errors.assignmentPrice &&
