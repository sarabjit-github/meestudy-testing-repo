...
export const TutorSubmissionModal = ({
  setIsTutorSubmissionModalOpen,
  clickedProjectDetails,
}) => {
  const submissionModalRef = useClickOutside(() => {
    setIsTutorSubmissionModalOpen(false);
  });
  useEffect(() => {
      ...
      >
        <div className={glassStyles.header}>
          ...
          <button
            ...
            onClick={() => setIsTutorSubmissionModalOpen(false)}
          >
            Close
          </button>
        </div>
