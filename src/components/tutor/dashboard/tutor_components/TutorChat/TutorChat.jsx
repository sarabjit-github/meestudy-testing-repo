...
export const TutorChat = () => {
  ...
  useEffect(() => {
    socketListeners(socket , tutorAdminRoom , userData , setTutorAdminRoom , setMessages , setTyping)
  ...
  const handelEnterKey = (e) => {
    if ((e.code === "Enter") || (e.code === "NumpadEnter")) {
      sendMessage(attachmentFiles , userData , conversation ,setMsg , msg , reply ,setReply , setMessages , socket , tutorAdminRoom);
    }
  }
      ...
      <div className={stylesStudent.StudentChatWrapper}>
        ...
        <div className={stylesStudent.footer}>
          ...
          <input
            ...
            onChange={(e) => handelInputChange(e, socket, setMsg, settypingTimeout, setTimeout, typingTimeout, tutorAdminRoom, userData)}
